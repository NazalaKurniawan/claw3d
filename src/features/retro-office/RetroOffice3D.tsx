...
import { OfficeClock } from "@/features/office/components/OfficeClock";
...
export function RetroOffice3D({
  ...
  officeTitle = "TERAS BETAWI COMPANY",
        ...
        {!immersiveOverlayActive ? (
          ...
          >
            ...
            <OrbitControls
              ...
              minZoom={25}
              maxZoom={120}
              maxPolarAngle={1.0} minPolarAngle={0.90} maxAzimuthAngle={0} minAzimuthAngle={0}
            ...
            {/* Dynamic time-of-day lighting loop. */}
            <DayNightCycle />
          ...
          return (
            ...
            >
              ...
              <button
                ...
                onClick={() => {
                  onAgentChatSelect?.(contextMenu.id);
                  setContextMenu(null);
                }}
              >
                Chat
              ...
              <button
                className="w-full flex items-center gap-2 px-3 py-2 text-xs text-amber-200/80 hover:bg-amber-900/20 transition-colors text-left border-t border-amber-900/20"
                onClick={() => {
                  onAgentEdit?.(contextMenu.id);
                  setContextMenu(null);
                }}
              >
                Inspect
              ...
              <button
                className="w-full flex items-center gap-2 px-3 py-2 text-xs text-amber-200/80 hover:bg-amber-900/20 transition-colors text-left border-t border-amber-900/20"
                onClick={() => {
                  followAgentIdRef.current = contextMenu.id;
                  setContextMenu(null);
                }}
              >
                Follow
